...
# diff from vgg16.py 
base_model = tf.keras.applications.MobileNet(input_shape = input_shape, include_top=False, weights=None) 
                                             
x = Flatten()(base_model.output)
#x = GlobalAveragePooling2D()(base_model.output) 
x = Dropout(0.2)(x)
x = Dense(1024, activation='relu')(x) # diff from vgg16.py
x = Dropout(0.2)(x)
